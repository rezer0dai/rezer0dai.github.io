...
Reinforcement Learning project, which trying to address [Request for reseach ( HER oriented ) from OpenAI](https://openai.com/blog/ingredients-for-robotics-research/#requestsforresearchheredition). And next iteration of original Wheeler project.
...
### PPO
algorithm heads, soft-actor-critic, replay buffer
### N-state
...
### Actor-Critic design
Encoders + Actor + Critic; Sync delta; Clipping gradients; advantages boost;
multiple critics;
### Task wrapper
