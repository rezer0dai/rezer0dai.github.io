...
On the bottom note, seems introducing many noisy heads does not help as much, contradictory it seems breaks training, though need better evaluation and code corrections (mainly at part of synchronizing target with multiple explorer heads).
...
Reacher environment episode is originally 1000 steps length, and have relatively complex reward function, and not exactly specified state-goal connection.
